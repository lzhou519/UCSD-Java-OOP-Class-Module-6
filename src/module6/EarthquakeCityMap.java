...
public class EarthquakeCityMap extends PApplet {
	...
	private void sortAndPrint(int numToPrint){
		...
		for (Marker qM : quakeMarkers) {
			eqm = (EarthquakeMarker)qM;
			quakeMarkerList.add(eqm);
		}
		Collections.sort(quakeMarkerList);
		//System.out.println(quakeMarkerList.size());
		for (int i = 0; i < numToPrint && i < quakeMarkerList.size(); i++) {
			System.out.println("Sorted: " + quakeMarkerList.get(i));
		}
	}
